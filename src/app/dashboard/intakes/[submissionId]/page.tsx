        ...
        <div>
          ...
          <details className="technical-details client-review-technical-details">
            ...
            <dl>
              ...
              {isFallbackRegistrationReference ? <div><dt>Fallback note</dt><dd>Legacy fallback reference shown for an older registration without a persisted reference.</dd></div> : null}
            </dl>
          </details>
