...
export const PERMISSIONS = {
  ...
  GENERATE_CLEAR_REPORT: 'generate_clear_report',
  EDIT_CLEAR_REPORT: 'edit_clear_report',
  REVIEW_CLEAR_REPORT: 'review_clear_report',
  SHARE_CLEAR_REPORT: 'share_clear_report',
  VIEW_CLEAR_REPORT: 'view_clear_report',
  MANAGE_MIGRATION_REFERENCE_DATA: 'manage_migration_reference_data',
  APPROVE_MIGRATION_REFERENCE_DATA: 'approve_migration_reference_data',
  VIEW_MIGRATION_REFERENCE_DATA: 'view_migration_reference_data',
  PREPARE_CLEAR_REPORT: 'prepare_clear_report',
  APPROVE_STANDARD_CLEAR_REPORT: 'approve_standard_clear_report',
  REQUEST_AUSTRALIA_CLEAR_REVIEW: 'request_australia_clear_review',
  COMPLETE_AUSTRALIA_CLEAR_REVIEW: 'complete_australia_clear_review',
  OVERRIDE_CLEAR_REPORT_APPROVAL: 'override_clear_report_approval',
  VIEW_LEGAL_REFERENCE: 'view_legal_reference',
  MANAGE_LEGAL_REFERENCE: 'manage_legal_reference',
  REVIEW_LEGAL_REFERENCE: 'review_legal_reference',
  APPROVE_LEGAL_REFERENCE: 'approve_legal_reference',
} as const;
...
export const ROLE_PERMISSIONS: Record<RoleKey, PermissionKey[]> = {
  ...
  senior_staff: [
    ...
    PERMISSIONS.GENERATE_CLEAR_REPORT,
    PERMISSIONS.EDIT_CLEAR_REPORT,
    PERMISSIONS.REVIEW_CLEAR_REPORT,
    PERMISSIONS.SHARE_CLEAR_REPORT,
    PERMISSIONS.VIEW_CLEAR_REPORT,
    PERMISSIONS.VIEW_MIGRATION_REFERENCE_DATA,
    PERMISSIONS.PREPARE_CLEAR_REPORT,
    PERMISSIONS.APPROVE_STANDARD_CLEAR_REPORT,
    PERMISSIONS.REQUEST_AUSTRALIA_CLEAR_REVIEW,
    PERMISSIONS.COMPLETE_AUSTRALIA_CLEAR_REVIEW,
    PERMISSIONS.OVERRIDE_CLEAR_REPORT_APPROVAL,
    PERMISSIONS.VIEW_LEGAL_REFERENCE,
    PERMISSIONS.MANAGE_LEGAL_REFERENCE,
    PERMISSIONS.REVIEW_LEGAL_REFERENCE,
    PERMISSIONS.APPROVE_LEGAL_REFERENCE,
  ],
  kenya_intake_staff: [
    PERMISSIONS.VIEW_DASHBOARD,
    PERMISSIONS.VIEW_INTAKE_DETAILS,
  ...
  australia_migration_team: [
    ...
    PERMISSIONS.REVIEW_CLEAR_REPORT,
    PERMISSIONS.VIEW_CLEAR_REPORT,
    PERMISSIONS.MANAGE_MIGRATION_REFERENCE_DATA,
    PERMISSIONS.VIEW_MIGRATION_REFERENCE_DATA,
    PERMISSIONS.COMPLETE_AUSTRALIA_CLEAR_REVIEW,
    PERMISSIONS.VIEW_LEGAL_REFERENCE,
    PERMISSIONS.MANAGE_LEGAL_REFERENCE,
